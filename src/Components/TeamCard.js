...
import { MDBCol, MDBCard, MDBCardUp, MDBCardBody, MDBAvatar, MDBRotatingCard, MDBIcon } from "mdbreact";
            ...
            <MDBCol className="col-md-2" style={{ minHeight: '26rem' }}>
                <MDBRotatingCard flipped={this.state.flipped} className="text-center h-100 w-100" style={colStyle}>
                    <MDBCard className="face front" style={{ background: "#0A1250" }}>
                        ...
                        <MDBCardBody>
                            <h4 className="font-weight-bold mb-3" style={{ color: "#e37373" }}> {this.props.emp.name} </h4>
                            <p className="font-weight-bold white-text" style={{ margin: "0" }}>{this.props.emp.role}</p>
